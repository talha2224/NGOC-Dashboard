      ...
      {selectAmoutModel && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
          <div className="bg-white p-6 w-[25rem] rounded-lg relative">
            ...
            <input onChange={(e) => { setSendData({ ...sendData, amount: e.target.value }) }} type="number" name="" id="" className="w-[100%] h-[2.5rem] rounded-md border my-2 px-3 outline-none" min="1" max="2900" placeholder="Enter Amount In USD" />
